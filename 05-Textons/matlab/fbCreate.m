function [fb] = fbCreate(numOrient,startSigma,numScales,scaling,elong,support)
% function [fb] = fbCreate(numOrient,startSigma,numScales,scaling,elong,support)
%
...
if nargin<1, numOrient = 8; end
if nargin<2, startSigma = 1; end
if nargin<3, numScales = 2; end
if nargin<4, scaling = sqrt(2); end
if nargin<5, elong = 2; end
if nargin<6, support = 3; end
